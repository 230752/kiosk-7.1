    ...
    <div class="pl-20 pr-20">
        <div class="shadow-xl m-auto p-7 rounded-lg">
            <div class="flex flex-row gap-4">
                <button
                    class="flex gap-3 min-w-44 flex-row border-2 shadow-lg border-custom_oranges bg-custom_orange p-3  items-center">
                    <div class="flex items-center justify-center w-10 h-10 bg-custom_oranges rounded-full"><svg
                            xmlns=" http://www.w3.org/2000/svg" viewBox="0 0 24 24" class=" text-white">
                ...
                <button
                    class="flex gap-3 min-w-44 shadow-lg flex-row border-2 border-custom_oranges bg-custom_orange p-3  items-center">
                    <div class="flex items-center justify-center w-10 h-10 bg-custom_oranges rounded-full"><svg
                            xmlns=" http://www.w3.org/2000/svg" viewBox="0 0 24 24" class=" text-white">
                            <path fill="currentColor" d="M9 16.2l-3.5-3.5l1.4-1.4l2.1 2.1l5.3-5.3l1.4 1.4z" />
                        </svg>
