...
@section('content')
    <div id="content-container" class="pt-12">
        <div id="option-btn-container">
            <button class="text-gray-500 border border-gray-500 rounded text-3xl px-4 py-2">Take away</button>
            <button class="text-gray-500 border border-gray-500 rounded text-3xl px-4 py-2">Eat in</button>
        </div>
...
@section('footer')
    <div id="footer-content" class="bg-white shadow-top-lg h-32 flex justify-between flex-row gap-8 items-center pl-4">
        <div id="access-btn-container" class="flex flex-row gap-8 h-18">
            <button class="flex items-center shadow border border-gray-500 rounded p-4"><svg xmlns="http://www.w3.org/2000/svg"
            ...
            <button class="flex items-center gap-2 shadow border border-gray-500 rounded p-4">
        ...
        <div id="shop-btn-container" class="pr-4 flex gap-8 items-center">
            <a href="#" class="border border-gray-500 rounded text-2xl pl-12 pr-12 p-4">Cancel order</a>
