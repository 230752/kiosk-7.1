...
@section('footer')
    <div id="footer-content" class="bg-white shadow-top-lg h-32 flex flex-row gap-8 items-center pl-4">
        <div id="access-btn-container" class="flex flex-row gap-8 h-18">
            <button class="flex items-center shadow border border-gray-300 rounded p-4"><svg xmlns="http://www.w3.org/2000/svg"
            ...
            <button class="flex items-center gap-2 shadow border border-gray-300 rounded p-4">
