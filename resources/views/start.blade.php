...
<div class="flex h-full pt-44  gap-24 flex-col">
    ...
    <div class="flex justify-center gap-16">
        <a href="" onclick="" class="text-center shadow-lg rounded-xl bg-custom_gray p-10">
            <img src="{{ asset('img/very_happy.webp') }}" alt="">
            <p class="text-6xl font-bold">Eat in</p>
        </a>
        <a href="" onclick="" class="text-center shadow-lg bg-custom_gray rounded-xl p-10">
...
@section('footer')
<div class="flex gap-6 p-5 shadow-top-lg h-22 items-center bg-white">
