...
<div class="flex flex-row w-full">
    <div class="w-56 h-full flex flex-col items-center bg-custom_gray">
        ...
        <div class="flex justify-center">
            <button class="category-button flex flex-col items-center justify-center  h-56 w-56 bg-green " onclick="filterProducts({{ $categorie['category_id'] }}, this)">
...
<div id="myModal" onclick="closeModal()" class="fixed inset-0 z-30 flex items-center justify-center bg-black bg-opacity-50 hidden">
    <div class="bg-white gap-4 flex flex-row p-5 rounded-lg shadow-lg w-4/5">
        ...
        <div class="w-1/2 h-full">
            ...
            <p id="modalDescription" class="mb-4 text-3xl">A blend of acai, banana, and mixed berries topped with granola, chia seeds, and coconut flakes.
            <p>
